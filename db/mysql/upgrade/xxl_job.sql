...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (3, 'unione-demo', 'unione-demo', 0, NULL, '2025-10-31 22:51:06');
...
-- ----------------------------
INSERT INTO `xxl_job_info` VALUES (4, 3, '定时输出', '2025-10-31 22:03:25', '2025-10-31 22:43:24', 'jeking', '', 'CRON', '0 0 * * * ? *', 'DO_NOTHING', 'FAILOVER', 'unione-demo-time-print', '{\"t\":123}', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2025-10-31 22:03:25', '', 1, 1761921780000, 1761922800000);
...
-- ----------------------------
INSERT INTO `xxl_job_user` VALUES (1, 'admin', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'a65cbf8e499e4b04bbd21d7441894520', 1, NULL);
