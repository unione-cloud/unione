...
@Data
@Builder
@SqlResource("data.SysDataFieldRelease")
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
@Table(name="sys_data_field_release")
public class SysDataFieldRelease extends Pojo {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6030732853230112807L;
	/**
	* 应用ID
	*/
