...
/**
 * @标题 	CommCommentTarget Entity
 * @描述	通用：评论目标，如，是否关闭评论，是否开启点赞，是否审核等等
...
@Builder
@DataPermis
@SqlResource("common.CommCommentTarget")
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
@Table(name="comm_comment_target")
public class CommCommentTarget extends Pojo {
	/**
	...
	*/
	...
	/**
	* 是否开启审核，字典TUREORFALSE 1是，0否，默认不审核
	*/
	@Schema(title="是否开启审核，字典TUREORFALSE 1是，0否，默认不审核",description="长度为：10")
